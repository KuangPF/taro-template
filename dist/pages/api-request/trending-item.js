...
var TrendingItem = (_temp2 = _class = function (_Taro$PureComponent) {
  _inherits(TrendingItem, _Taro$PureComponent);
  ...
  function TrendingItem() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = TrendingItem.__proto__ || Object.getPrototypeOf(TrendingItem)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "data", "index"], _this.handleViewDetail = function (data) {
  ...
  _createClass(TrendingItem, [{
    ...
    value: function _createData() {
      ...
      this.anonymousFunc0 = function () {
        _this2.handleViewDetail(data);
      };

      var anonymousState__temp = (0, _index.internal_inline_style)({ backgroundColor: data.languageColor });
